"use strict";
(self["webpackChunkheallo_doctor"] = self["webpackChunkheallo_doctor"] || []).push([[429],{
...
/* harmony import */ var audio_recorder_polyfill__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! audio-recorder-polyfill */ 46264);
/**
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _w_doctor_doctor_node_modules_babel_runtime_helpers_esm_classCallCheck_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/classCallCheck.js */ 75134);
/* harmony import */ var _w_doctor_doctor_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/createClass.js */ 47289);
/* harmony import */ var _wave_encoder_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./wave-encoder/index.js */ 51619);
...
var createWorker = function createWorker(fn) {
  var js = fn.toString().replace(/^(\(\)\s*=>|function\s*\(\))\s*{/, '').replace(/}$/, '');
  var blob = new Blob([js]);
  return new Worker(URL.createObjectURL(blob));
};

var error = function error(method) {
...
var MediaRecorder = /*#__PURE__*/function () {
  /**
  ...
  function MediaRecorder(stream) {
    ...
    (0,_w_doctor_doctor_node_modules_babel_runtime_helpers_esm_classCallCheck_js__WEBPACK_IMPORTED_MODULE_0__["default"])(this, MediaRecorder);
  ...
  (0,_w_doctor_doctor_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_1__["default"])(MediaRecorder, [{
    key: "start",
    value: function start(timeslice) {
      ...
      this.processor.onaudioprocess = function (e) {
        if (_this.state === 'recording') {
          _this.encoder.postMessage(['encode', e.inputBuffer.getChannelData(0)]);
        }
      };
      ...
      if (timeslice) {
        this.slicing = setInterval(function () {
          if (_this.state === 'recording') _this.requestData();
        }, timeslice);
      }
    ...
    value: function addEventListener() {
      ...
      (_this$em = this.em).addEventListener.apply(_this$em, arguments);
    }
    /**
    ...
    value: function removeEventListener() {
      ...
      (_this$em2 = this.em).removeEventListener.apply(_this$em2, arguments);
    }
    /**
    ...
    value: function dispatchEvent() {
      ...
      (_this$em3 = this.em).dispatchEvent.apply(_this$em3, arguments);
    }
  }]);
...
MediaRecorder.encoder = _wave_encoder_index_js__WEBPACK_IMPORTED_MODULE_2__["default"];
